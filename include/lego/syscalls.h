...
// ipc
asmlinkage long sys_mq_send(char* mq_name, int msg_size, const char* msg);
asmlinkage long sys_mq_open(char* mq_name, int msg_size);
asmlinkage long sys_mq_receive(char* mq_name, int msg_size, char* msg);
